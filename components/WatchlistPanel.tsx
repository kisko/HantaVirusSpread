...
export default function WatchlistPanel({
  ...
  return (
    <section className="frost-panel-strong animate-rise-in absolute bottom-[12.5rem] right-4 z-30 flex max-h-[min(24rem,calc(100%-15rem))] w-[min(360px,calc(100%-32px))] flex-col rounded-2xl p-3" aria-label="Watchlist alerts">
